...
public boolean verificarColision(EnemigoAnimado enemigoAnimado) {
		
		if (obtenerRectangulo().intersects(enemigoAnimado.obtenerRectangulo().getBoundsInLocal()) && !enemigoAnimado.isCapturado()) {
